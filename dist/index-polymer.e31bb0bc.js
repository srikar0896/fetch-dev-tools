...
},{"lit-element":"node_modules/lit-element/lit-element.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
class FetchDevTools extends _litElement.LitElement {
  constructor() {
    super();
    this.requests = [{
      id: 1,
  ...
  render() {
    ...
    <div class="devtools__wrapper">
      ${this.requests.length === 0 ? (0, _litElement.html)`<center><code>No Requests</code></center>` : (0, _litElement.html)`
          ${this.requests.map(request => (0, _litElement.html)`<fetch-devtools-requestitem request=${JSON.stringify(request)}></fetch-devtools-requestitem>`)}
        `}
      </div>
    `;
  }
...
},{"lit-element":"node_modules/lit-element/lit-element.js","./RequestItem":"RequestItem.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/index-polymer.e31bb0bc.js.map